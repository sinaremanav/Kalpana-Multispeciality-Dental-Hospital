        ...
        {selectedImage && (
          ...
          >
            ...
            >
              <button
                onClick={() => setSelectedImage(null)}
                className="absolute top-4 right-4 z-10 w-9 h-9 rounded-lg bg-[#0F172A]/70 hover:bg-[#0F172A] text-white flex items-center justify-center transition-colors border border-white/20"
              >
                <X className="w-5 h-5" />
              </button>
              ...
              <div className="p-6 bg-white">
                ...
                <p className="text-[#475569] text-sm mt-1">{selectedImage.desc}</p>
              </div>
            </motion.div>
          </motion.div>
        )}
